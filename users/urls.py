...
urlpatterns = [
    ...
    path("admin/users/<int:user_id>/toggle/",      toggle_user_active_view,   name="toggle_user_active_view"),
    path("admin/users/<int:user_id>/change-role/", change_user_role_view,     name="change_user_role_view"),

    # ── admin: roles & permissions ─────────────
    path("admin/roles/",        roles_permissions_view,       name="roles_permissions_view"),
    path("admin/roles/update/", update_role_permissions_view, name="update_role_permissions_view"),
]
